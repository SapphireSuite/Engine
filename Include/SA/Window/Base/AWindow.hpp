	...
	*/
	...
	public:
		...
		*/
		...
		virtual Vk::Surface CreateVkRenderSurface(const Vk::Instance& _instance) const = 0;
		virtual void DestroyVkRenderSurface(const Vk::Instance& _instance, Vk::Surface& _surface) const = 0;
