...
namespace Sa
{
	...
	public:
		...
		*/
		SA_ENGINE_API static RenderPassDescriptor DefaultSingle(const ARenderSurface* _surface = nullptr);

		/**
		*	\brief Create a default multi-pass PBR deferred rendering renderpass descriptor.
		*/
		SA_ENGINE_API static RenderPassDescriptor DefaultPBR(const ARenderSurface* _surface = nullptr);
	};
}
